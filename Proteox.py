...
decs_visa_path = r"C:\Users\FSCV_Computer\anaconda3\envs\qcodes\Lib\site-packages\qcodes_contrib_drivers\drivers\OxfordInstruments\_decsvisa\src\decs_visa.py"
...
class oiDECS(VisaInstrument):
    ...
    def __init__(self, name, **kwargs):
        ...
        # If DECS shows an error popup (e.g. magnet disconnected), it blocks
        # all WAMP command processing until dismissed. Wait for the user to
        # dismiss it before the driver registers parameters and returns.
        print("\nIf a DECS error popup appeared, dismiss it now, then press Enter.")
        print("If no popup appeared, just press Enter immediately.")
        input("> ")
